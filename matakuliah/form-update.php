...
$kode = $_GET['kode'];
$query = "SELECT kode, nama_matkul, sks, semester, matakuliah.id_dosen, nama_dosen FROM matakuliah LEFT JOIN dosen USING(id_dosen)
WHERE kode = '$kode'";
echo $query;
...
<body>
    ...
    <form action = "update.php" method="post">
        <table>
            ...
            <tr> 
                <label for = "nama_dosen">Dosen Pengajar</label></td> <td> : </td>
            ...
            <td></td> <td> </td> <td> <input type="submit" value="Simpan"></td></input>
</tr>
</form>
</table>
</body> 
